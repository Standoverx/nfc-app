...
export function AssistanceSection() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-24 bg-accent rounded-3xl p-12">
      <Link href="/contact">
        <Card className="p-6 hover:shadow-lg transition-shadow flex items-center gap-4 bg-background cursor-pointer">
